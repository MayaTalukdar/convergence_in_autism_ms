...
#read in comparisons
comparisons <- unname(unlist(read.table("/n/groups/walsh/indData/Maya/Finalized_Convergence_In_ASD/Cell_Lines/figures/analysis_of_mo_dias_15q_data/comparisons.txt", header = F))) #In Input_Files_Not_Generated_By_Scripts
genes_to_analyze <- c(
