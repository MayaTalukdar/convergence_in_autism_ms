#NOTE: ALL INPUT THAT WAS NOT GENERATED BY SCRIPTS CAN BE FOUND IN Input_Files_Not_Generated_By_Scripts
...
oliva_data <- fread("/n/groups/walsh/indData/Maya/Finalized_Convergence_In_ASD/Organoids/figures/figures_for_manuscript/get_sex_assoc_regs/X_Linked_Gene_Classes/GTEx_Analysis_v8_sbgenes/signif.sbgenes.txt", header = TRUE) %>% as.data.frame()
