...
################
#RUN OVERLAP (list1 = CRISPR downreg DEGs, list2 = shRNA downreg DEGs)
################
...
colnames(plot_df) <- c("pval", "OR", "lower.ci", "InList1AndList2", "InList1AndNotList2", "InList2AndNotList1", "InNeither")
...
write.table(plot_df, "/n/groups/walsh/indData/Maya/Finalized_Convergence_In_ASD/Final_Submission/Code/Actually_Submitted/For_Third_Submission_And_What_We_Published/1_CLEANED_1_Figure_S4/1_Figure_S4D_Comparison_DEGs_shRNA_CRISPR_KDs/downreg_deg_overlap_barplot_source_data.txt", sep = "\t", row.names = FALSE, col.names = TRUE, quote = FALSE)

#plot
cols <- c(brewer.pal(8, "Greens")[c(8, 6)], "lightgray")
pdf("/n/groups/walsh/indData/Maya/Finalized_Convergence_In_ASD/Final_Submission/Code/Actually_Submitted/For_Third_Submission_And_What_We_Published/1_CLEANED_1_Figure_S4/1_Figure_S4D_Comparison_DEGs_shRNA_CRISPR_KDs/downreg_deg_overlap_barplot.pdf", height = 3, width = 5)
