...
pdf("/n/groups/walsh/indData/Maya/Finalized_Convergence_In_ASD/Final_Submission/Code/Actually_Submitted/For_Rebuttal/Output/Figures/Volcano_Plots/Combined_Volcano_Plots_shRNA_KDs_cut_x_outliers.pdf",
    width = 30,
    height = 18)
...
pdf("/n/groups/walsh/indData/Maya/Finalized_Convergence_In_ASD/Final_Submission/Code/Actually_Submitted/For_Rebuttal/Output/Figures/Volcano_Plots/Combined_Volcano_Plots_shRNA_KDs_full_x_axis.pdf",
    width = 24,
    height = 6)
