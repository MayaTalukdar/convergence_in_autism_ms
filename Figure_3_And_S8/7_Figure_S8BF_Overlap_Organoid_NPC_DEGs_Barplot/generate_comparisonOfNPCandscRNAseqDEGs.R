...
colnames(overlap_res_df) <- c("pval", "OR", "lower.ci")
...
pdf("/n/groups/walsh/indData/Maya/Finalized_Convergence_In_ASD/Final_Submission/Code/Figure_3/6B_LT_day30_RG_and_NPCs_degOverlapBarplot.pdf", height = 3, width = 5)
...
for (type in types)
{
  ...
  pdf(paste0("/n/groups/walsh/indData/Maya/Finalized_Convergence_In_ASD/Final_Submission/Code/Figure_3/7D_AD_day60_", type, "_and_NPCs_degOverlapBarplot.pdf"), height = 3, width = 5)
