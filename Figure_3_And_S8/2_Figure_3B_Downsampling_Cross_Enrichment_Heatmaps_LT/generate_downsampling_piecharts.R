...
for (day in c("day60"))
{
  ...
  guides <- unname(unlist(read.table("/n/groups/walsh/indData/Maya/Finalized_Convergence_In_ASD/Organoids/figures/build_organoid_atlas/guides_downsample.txt", header = FALSE)))
