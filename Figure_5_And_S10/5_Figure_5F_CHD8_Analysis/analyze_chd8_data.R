...
#read in chd8 data
chd8_data <- read.csv("/n/groups/walsh/indData/Maya/Finalized_Convergence_In_ASD/Cell_Lines/raw_data/sugathan_data_chd8.csv", header = TRUE)
...
colnames(enr_df) <- c("pval", "OR", "lower.ci")
...
pdf("/n/groups/walsh/indData/Maya/Finalized_Convergence_In_ASD/Final_Submission/Code/Figure_5_And_S5/Figure_5F_CHD8_Analysis/CHD8_enr_barplot.pdf", width = 6, height =3)
