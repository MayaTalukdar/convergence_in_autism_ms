...
all_regs <- unname(unlist(read.table("/n/groups/walsh/indData/Maya/Finalized_Convergence_In_ASD/Cell_Lines/figures/half_heldout_aracne_network_analysis/Output/regs_to_test.txt", header = FALSE))) #In Input_Files_Not_Generated_By_Scripts
all_regs <- setdiff(all_regs, c("SETD1B", "EHMT1")) #these regulators removed bc their regulon size is < 250
baseMean_in_NTCs <- read.table("/n/groups/walsh/indData/Maya/Finalized_Convergence_In_ASD/Cell_Lines/raw_data/process_perturbation_data_all_perturbations/differential_expression_analysis/baseMeanInNTCs.csv", row.names = 1) #In Input_Files_Not_Generated_By_Scripts
...
potential_regs <- unname(unlist(read.csv("/n/groups/walsh/indData/Maya/Finalized_Convergence_In_ASD/Cell_Lines/figures/half_heldout_aracne_network_analysis/Input/RegulatorsList/ProcessedLists/all_NPC_expressed_TFs_and_epigenetic_regulators.csv", header = FALSE))) #In Input_Files_Not_Generated_By_Scripts
