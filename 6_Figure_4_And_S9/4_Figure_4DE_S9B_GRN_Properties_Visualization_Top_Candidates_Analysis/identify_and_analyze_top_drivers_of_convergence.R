...
targets <- unname(unlist(read.table("/n/groups/walsh/indData/Maya/Finalized_Convergence_In_ASD/Cell_Lines/raw_data/process_perturbation_data_all_perturbations/final_targets_to_carry_forward.csv"))) #In Input_Files_Not_Generated_By_Scripts
...
pathway_list <- c(pathway_list, gmtPathways("/n/groups/walsh/indData/Maya/Finalized_Convergence_In_ASD/Cell_Lines/figures/full_aracne_network_analysis/Input/Ontologies/h.all.v2023.2.Hs.symbols.gmt")) #In Input_Files_Not_Generated_By_Scripts
