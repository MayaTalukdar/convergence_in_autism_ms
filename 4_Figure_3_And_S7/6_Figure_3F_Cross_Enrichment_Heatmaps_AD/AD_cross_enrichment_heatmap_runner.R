...
# #rlist.dirs(path, recursive = FALSE), 
#   function(x) {
#     setNames(
#       lapply(
...
# saveRDS(final_DEG_res_list, "/n/groups/walsh/indData/Maya/Finalized_Convergence_In_ASD/Organoids/figures/figures_for_manuscript/generate_fig_7e_s15c_s15d/full_DEG_res_list.RDS")
full_DEG_res_list <- readRDS("/n/groups/walsh/indData/Maya/Finalized_Convergence_In_ASD/Organoids/figures/figures_for_manuscript/generate_fig_7e_s15c_s15d/full_DEG_res_list.RDS")
...
for (type in names(cross_enrichment_res_adj_list))
{
  ...
  guide_names <- sapply(split_names, `[`, 1)  
  cell_type_names <- sapply(split_names, `[`, 3)  
