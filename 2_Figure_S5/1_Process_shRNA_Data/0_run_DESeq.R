...
processed_mat_merged <- fread("/n/groups/walsh/indData/Maya/Finalized_Convergence_In_ASD/Cell_Lines/raw_data/shRNA_perturbation_data_from_plasmidsaurus/K2Y3JM_results/K2Y3JM-expression-matrix.tsv") %>% as.data.frame() #ON GEO (GSE332571)
...
#read in sample key 
sample_key <- read.table("/n/groups/walsh/indData/Maya/Finalized_Convergence_In_ASD/Cell_Lines/raw_data/shRNA_perturbation_data_from_plasmidsaurus/Sample_Key_Plasmidsaurus.txt", header = TRUE) #In Input_Files_Not_Generated_By_Scripts
