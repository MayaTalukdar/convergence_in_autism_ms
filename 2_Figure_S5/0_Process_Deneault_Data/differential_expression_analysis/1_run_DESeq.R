...
metadata <- read.table("/n/groups/walsh/indData/Maya/Finalized_Convergence_In_ASD/Cell_Lines/raw_data/process_denault_perturbation_data/geo_files/sample_metadata.txt", header = FALSE)
...
#TODO: is there batch information?
