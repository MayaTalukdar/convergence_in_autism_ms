...
annots_from_becky <- fread("/n/groups/walsh/indData/Maya/Finalized_Convergence_In_ASD/Organoids/figures/build_organoid_atlas/full_metadata_updated_CellType_final.txt", header = TRUE) %>% as.data.frame()
