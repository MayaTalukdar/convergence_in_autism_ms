...
genes <- unname(unlist(read.table("/n/groups/walsh/indData/Maya/Finalized_Convergence_In_ASD/Final_Submission/Code/For_Initial_Submission/Figure_1_And_S1/Figure_1C_Enrichment_Barplot_DEGs/Demo/Demo_Input_Data/final_targets_to_carry_forward.csv", header = FALSE)))
genes <- unname(sapply(genes, function(x) gsub("_", "-", x)))
path <- "/n/groups/walsh/indData/Maya/Finalized_Convergence_In_ASD/Final_Submission/Code/For_Initial_Submission/Figure_1_And_S1/Figure_1C_Enrichment_Barplot_DEGs/Demo/Demo_Input_Data/DEG_Results/"
...
#read in SFARI genes 
sfari <- read.csv("/n/groups/walsh/indData/Maya/Finalized_Convergence_In_ASD/Final_Submission/Code/For_Initial_Submission/Figure_1_And_S1/Figure_1C_Enrichment_Barplot_DEGs/Demo/Demo_Input_Data/sfari.csv", header = TRUE)
SFARI_genes <- unique(sfari$gene.symbol)
all_SFARI_genes <- SFARI_genes


#read in ID genes 
id_genes <- read.csv("/n/groups/walsh/indData/Maya/Finalized_Convergence_In_ASD/Final_Submission/Code/For_Initial_Submission/Figure_1_And_S1/Figure_1C_Enrichment_Barplot_DEGs/Demo/Demo_Input_Data/SysNDD_ID_genes_definitive.csv", header = TRUE)
...
pdf("/n/groups/walsh/indData/Maya/Finalized_Convergence_In_ASD/Final_Submission/Code/For_Initial_Submission/Figure_1_And_S1/Figure_1C_Enrichment_Barplot_DEGs/Demo/Demo_Expected_Output/SFARI_gene_enrichment_barplot.pdf", height = 3, width = 5)
...
#create plot
cols <- "lightgray"
pdf("/n/groups/walsh/indData/Maya/Finalized_Convergence_In_ASD/Final_Submission/Code/For_Initial_Submission/Figure_1_And_S1/Figure_1C_Enrichment_Barplot_DEGs/Demo/Demo_Expected_Output/id_gene_enrichment_barplot.pdf", height = 3, width = 5)
...
###################
pdf("/n/groups/walsh/indData/Maya/Finalized_Convergence_In_ASD/Final_Submission/Code/For_Initial_Submission/Figure_1_And_S1/Figure_1C_Enrichment_Barplot_DEGs/Demo/Demo_Expected_Output/sfari_id_gene_enrichment_barplot.pdf", height = 3, width = 10)
...
write.table(merged_df, "/n/groups/walsh/indData/Maya/Finalized_Convergence_In_ASD/Final_Submission/Code/For_Initial_Submission/Figure_1_And_S1/Figure_1C_Enrichment_Barplot_DEGs/Demo/Demo_Expected_Output/supp_table_fig_1c.txt", sep = "\t", row.names = F, col.names = T, quote = F)