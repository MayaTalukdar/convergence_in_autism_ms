...
paths <- unlist(read.table("/n/groups/walsh/indData/Maya/Finalized_Convergence_In_ASD/Cell_Lines/raw_data/run_alignment/pathsToAlevinOutput_withDedup.txt", header = FALSE)) #text file containing paths to alevin output; can generate using readlink -f 
