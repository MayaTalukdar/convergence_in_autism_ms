...
#note: script here shown for file 1B but works with any CheapSeq output
...
--dumpMtx \
--whitelist /n/groups/walsh/indData/Maya/Finalized_Convergence_In_ASD/Cell_Lines/raw_data/run_alignment/Combinatorial_Index.txt  \ #In Input_Files_Not_Generated_By_Scripts
