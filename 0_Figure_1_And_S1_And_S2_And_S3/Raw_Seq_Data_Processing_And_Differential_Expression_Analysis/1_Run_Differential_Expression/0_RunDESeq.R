...
sample_key <- read.table("/n/groups/walsh/indData/Maya/Finalized_Convergence_In_ASD/Cell_Lines/raw_data/run_alignment/ASD_Screen_Sample_Key_AllReps_updated.txt", header = TRUE) #In Input_Files_Not_Generated_By_Scripts
all_perturbations <- unname(unlist(read.csv("/n/groups/walsh/indData/Maya/Finalized_Convergence_In_ASD/Cell_Lines/raw_data/process_perturbation_data_all_perturbations/differential_expression_analysis/all_perturbations.csv", header = FALSE))) #In Input_Files_Not_Generated_By_Scripts
...
pathsToAlevinOutput_withDedup <- setNames(unlist(read.table("/n/groups/walsh/indData/Maya/Finalized_Convergence_In_ASD/Cell_Lines/raw_data/run_alignment/pathsToAlevinOutput_withDedup.txt", header = FALSE)), NULL)  #text file containing paths to alevin output; can generate using readlink -f 
...
saveRDS(metadata_merged, "/n/groups/walsh/indData/Maya/Finalized_Convergence_In_ASD/Cell_Lines/raw_data/process_perturbation_data_all_perturbations/differential_expression_analysis/metadata_merged.RDS")
