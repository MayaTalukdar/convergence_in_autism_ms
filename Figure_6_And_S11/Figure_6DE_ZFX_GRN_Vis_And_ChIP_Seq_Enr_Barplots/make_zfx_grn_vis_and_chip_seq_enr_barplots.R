...
rhie_path <- "/n/groups/walsh/indData/Maya/Finalized_Convergence_In_ASD/Cell_Lines/raw_data/zfx_zfy_data/Rhie_Genome_Res_2018/"
...
common_zfx_targets <- unname(unlist(read.csv("/n/groups/walsh/indData/Maya/Finalized_Convergence_In_ASD/Organoids/figures/figures_for_manuscript/get_sex_assoc_regs/4_perform_zfx_analysis/raw_data/targets_rhie_table_s3.csv", header = FALSE)))
...
#save plot
pdf("/n/groups/walsh/indData/Maya/Finalized_Convergence_In_ASD/Final_Submission/Code/For_Revisions/Redo_Figure_6_And_S6_To_Add_Decasien_Data/Figure_6DE_ZFX_GRN_Vis_And_ChIP_Seq_Enr_Barplots/zfx_top_candidates_graph.pdf")
...
colnames(enr_df) <- c("pval", "or", "lower.ci", "cellType")
...
pdf("/n/groups/walsh/indData/Maya/Finalized_Convergence_In_ASD/Final_Submission/Code/For_Revisions/Redo_Figure_6_And_S6_To_Add_Decasien_Data/Figure_6DE_ZFX_GRN_Vis_And_ChIP_Seq_Enr_Barplots/zfx_ChIP_enrichment.pdf", width = 6, height = 3)
